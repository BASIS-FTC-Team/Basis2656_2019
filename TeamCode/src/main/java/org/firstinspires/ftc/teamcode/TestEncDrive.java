...
public class TestEncDrive extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            //Move forward
            if (gamepad1.dpad_up) {
                driveTrain.moveForthBackEnc(0.5,500., 10000, opModeIsActive());
            ...
            if (gamepad1.dpad_left) {
                driveTrain.moveLeftRightEnc(0.5,-500., 10000, opModeIsActive());
            ...
            //Turn CCW
            if (gamepad1.x) {
                driveTrain.spinEnc(0.5,-45., 10000, opModeIsActive());
