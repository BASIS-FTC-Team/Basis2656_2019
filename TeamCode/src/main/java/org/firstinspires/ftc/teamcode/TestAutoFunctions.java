...
@TeleOp(name = "Test Auto Functions", group = "Test")
//@Disabled
public class TestAutoFunctions extends LinearOpMode {
...
//            //////////
            ...
            if (bH1.pressing(start)) {
                ...
                if (stepEnabled[1]) {
                    ...
                    timeRecorderList.clear();
                    setTimeRecordCheckPoint("AutoStart...");
                    /** Landing off */
                    ...
                    TelemetryWrapper.setLine(2,String.format("mR.update() - numM : %d, firstGold: %d,  gP : %s ",
                            mR.getNumM(),mR.getFirstGoldOrderFromLeft(), gP.toString()));
...
//
//
//                    setTimeRecordCheckPoint("Finished.");
//
//
////                    if (timeRecorderList.size() > 0) {
////                        TelemetryWrapper.clear();
...
//                    driveTrainEnc.moveForthBackEnc(1300., 5000);
//                }
                ...
                while (!bH1.pressing(right_bumper)) {
                    ...
                    if (bH1.pressing(a)) {
                        if (flashlightIsOn) {
                            ...
                            try {
                                mCameraManager.setTorchMode("0", true);// "0"是主闪光灯
                            } catch (Exception e) {
                            }
                            flashlightIsOn = true;
                        }
