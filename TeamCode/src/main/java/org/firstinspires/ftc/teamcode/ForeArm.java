...
//        newTarget3  = motor3.getCurrentPosition() - counts;
        motor3.setTargetPosition(motor3.getCurrentPosition() - counts);
...
/******************** End of Part III *********************************/
    ...
    public boolean isAutoUping() { return isAutoUping; }

    public boolean isAutoDowning() { return isAutoDowning; }

    public boolean isUpDownStopped() { return ((!isUping) && (!isDowning) && (!isAutoUping) && (!isAutoDowning)); }
